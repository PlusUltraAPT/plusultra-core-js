 ...
 */
export function findFirstKey (keyInfos: Array<PlusultraWalletInfo>, type: string) {
 ...
 */
export function mergeKeyInfos (keyInfos: Array<PlusultraWalletInfo>) {
  const out = []
...
export function getAllWalletInfos (
  login: LoginTree,
  legacyWalletInfos: Array<PlusultraWalletInfo> = []
) {
  const appIdMap: AppIdMap = {}
  const walletInfos: Array<PlusultraWalletInfo> = []
 ...
 */
export function fixWalletInfo (walletInfo: PlusultraWalletInfo): PlusultraWalletInfo {
