...
/**
 * The public API for plusultra login requests.
 */
class ABCPlusultraLoginRequest {
  id: string
  cancelRequest: () => void
 ...
 */
export function requestPlusultraLogin (
  ai: ApiInput,
  appId: string,
  opts: {
  ...
  return makeLobby(ai, request).then(lobby => {
    ...
    return new ABCPlusultraLoginRequest(lobby.lobbyId, subscription)
  })
}
