...
import { fakeUser, makeFakeIos } from '../../plusultra-core-index.js'
...
describe('repo', function () {
  it('local get', async function () {
    ...
    const box = `{
      "encryptionType": 0,
      "iv_hex": "82454458a5eaa6bc7dc4b40f36d1",
      "data_base64": "lykLWi2MUBbcrdbbo2cZ9Q97aVohe6LZUihr1neAMj8mr0l9MP1ElteAzG4GG1FmjSsptajr6I2sNc5Kmw=="
    }`

    await io.folder
      .folder('repos')
      .folder('GkVrxd1EmZpU6SkEwfo1t1WjwBDW3tdrKd7QUDvvN')
      .folder('changes')
      .folder('a')
      .file('b.json')
      .setText(box)
