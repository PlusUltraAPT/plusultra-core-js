...
import type { PlusultraExchangePlugin } from '../../plusultra-core-index.js'
...
export interface ExchangeOutput {
  plugins: Array<PlusultraExchangePlugin>;
  update: mixed;
}
...
export default combinePixies({
  plugins (input: PixieInput<RootProps>) {
    return (props: RootProps): any => {
      ...
      const promises: Array<Promise<PlusultraExchangePlugin>> = []
